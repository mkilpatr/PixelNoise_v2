// -*- C++ -*-
//
// Package:    JamesDigitizer/George
// Class:      George
// 
/**\class George George.cc JamesDigitizer/George/plugins/George.cc
...
*/
//
// Original Author:  Nicholas Menendez
//         Created:  Wed, 05 Jul 2017 14:59:30 GMT
//
//
...
class George : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
  public:
    explicit George(const ParameterSet&);
    ~George();
...
George::George(const ParameterSet& iConfig)
{
...
void George::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  numEvents->Fill(0);
  // Get digis
  ...
  helper = new TrackerHitAssociator::Config(iConfig_,consumesCollector());
  TrackerHitAssociator associate(iEvent, *helper);
...
void George::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
